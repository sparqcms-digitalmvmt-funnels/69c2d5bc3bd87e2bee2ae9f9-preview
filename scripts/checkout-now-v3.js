...
const DEFAULT_OFFER_ID = '285';
const getVrioOfferInfoByProductId = (productId) =>
  ((productId) => {
    const vrioOffers = [{"id":285,"offerTypeId":1,"name":"Blue Clarity Shield - Network","items":[{"name":"1x Blue Clarity Shield","id":1885,"quantity":1,"price":0,"shippable":false},{"name":"1x USB","id":1794,"quantity":1,"price":0,"shippable":false},{"name":"2x Blue Clarity Shields","id":1886,"quantity":1,"price":0,"shippable":false},{"name":"3x Blue Clarity Shields","id":1887,"quantity":1,"price":0,"shippable":false},{"name":"4x Blue Clarity Shields","id":1888,"quantity":1,"price":0,"shippable":false},{"name":"5x Blue Clarity Shields","id":1889,"quantity":1,"price":0,"shippable":false},{"name":"Blue Clarity Shield","id":1884,"quantity":1,"price":0,"shippable":true},{"name":"Blue Clarity Shield  Journey Package Protection","id":1891,"quantity":1,"price":0,"shippable":false},{"name":"Blue Clarity Shield - 3 Year Warranty","id":1890,"quantity":1,"price":0,"shippable":false},{"name":"Blue Clarity Shield - Case UPGRADE!","id":1894,"quantity":1,"price":0,"shippable":false},{"name":"Blue Clarity Shield - Expedited Shipping","id":1893,"quantity":1,"price":0,"shippable":false},{"name":"Special 1x EXTRA Blue Clarity Shield","id":1892,"quantity":1,"price":0,"shippable":false},{"name":"USB","id":1793,"quantity":1,"price":0,"shippable":true}]},{"id":286,"offerTypeId":2,"name":"Blue Clarity Shield - VIP","items":[{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":0,"shippable":false}]}];
...
const getPrices = () => {
  return [{"name":"1x Blue Clarity Shield","id":1885,"quantity":1,"price":0,"shippable":false,"fullPrice":39.99,"finalPrice":39.99,"productName":"1x Blue Clarity Shield","discountAmount":0,"discountPercentage":0},{"name":"1x USB","id":1794,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x USB","discountAmount":0,"discountPercentage":0},{"name":"2x Blue Clarity Shields","id":1886,"quantity":1,"price":0,"shippable":false,"fullPrice":75.98,"finalPrice":75.98,"productName":"2x Blue Clarity Shields","discountAmount":0,"discountPercentage":0},{"name":"3x Blue Clarity Shields","id":1887,"quantity":1,"price":0,"shippable":false,"fullPrice":107.97,"finalPrice":107.97,"productName":"3x Blue Clarity Shields","discountAmount":0,"discountPercentage":0},{"name":"4x Blue Clarity Shields","id":1888,"quantity":1,"price":0,"shippable":false,"fullPrice":135.96,"finalPrice":135.96,"productName":"4x Blue Clarity Shields","discountAmount":0,"discountPercentage":0},{"name":"5x Blue Clarity Shields","id":1889,"quantity":1,"price":0,"shippable":false,"fullPrice":159.95,"finalPrice":159.95,"productName":"5x Blue Clarity Shields","discountAmount":0,"discountPercentage":0},{"name":"Blue Clarity Shield  Journey Package Protection","id":1891,"quantity":1,"price":0,"shippable":false,"fullPrice":3.5,"finalPrice":3.5,"productName":"Blue Clarity Shield  Journey Package Protection","discountAmount":0,"discountPercentage":0},{"name":"Blue Clarity Shield - 3 Year Warranty","id":1890,"quantity":1,"price":0,"shippable":false,"fullPrice":9.95,"finalPrice":9.95,"productName":"Blue Clarity Shield - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"name":"Blue Clarity Shield - Case UPGRADE!","id":1894,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Blue Clarity Shield - Case UPGRADE!","discountAmount":0,"discountPercentage":0},{"name":"Blue Clarity Shield - Expedited Shipping","id":1893,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Blue Clarity Shield - Expedited Shipping","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Blue Clarity Shield","id":1892,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Blue Clarity Shield","discountAmount":0,"discountPercentage":0},{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0}]
};
...
const shippables = [{"id":1884,"name":"Blue Clarity Shield"},{"id":1793,"name":"USB"}];
...
async function createOrderViaWallet(confirmationToken, paymentMethodId) {
  ...
  const orderData = {
    pageId: "QpcAB7oicI4h7r9FpJUEfwqtsDLpizNvGz4qMb_oOj-eG21Vqt8_khiwzwH5ap61",
    action: "process",
...
const getStates = async (countryIso2Code) => {
  ...
  try {
    if (!countriesStatesCache) {
      const res = await fetch('/69c2d5bc3bd87e2bee2ae9f9-preview/scripts/countriesData/countriesStates.json', { cache: 'no-store' });
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      runId: "initial",
      hypothesisId: "KlaviyoLifecycle",
      data: { pageName: "BCS-Checkout", pageType: "Checkout" },
    };
