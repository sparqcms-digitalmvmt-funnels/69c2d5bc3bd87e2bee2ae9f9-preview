...
const prices = [{"name":"1x Blue Clarity Shield","id":1885,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x Blue Clarity Shield","discountAmount":0,"discountPercentage":0},{"name":"1x USB","id":1794,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x USB","discountAmount":0,"discountPercentage":0},{"name":"2x Blue Clarity Shields","id":1886,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"2x Blue Clarity Shields","discountAmount":0,"discountPercentage":0},{"name":"3x Blue Clarity Shields","id":1887,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"3x Blue Clarity Shields","discountAmount":0,"discountPercentage":0},{"name":"4x Blue Clarity Shields","id":1888,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"4x Blue Clarity Shields","discountAmount":0,"discountPercentage":0},{"name":"5x Blue Clarity Shields","id":1889,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"5x Blue Clarity Shields","discountAmount":0,"discountPercentage":0},{"name":"Blue Clarity Shield  Journey Package Protection","id":1891,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Blue Clarity Shield  Journey Package Protection","discountAmount":0,"discountPercentage":0},{"name":"Blue Clarity Shield - 3 Year Warranty","id":1890,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Blue Clarity Shield - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"name":"Blue Clarity Shield - Case UPGRADE!","id":1894,"quantity":1,"price":0,"shippable":false,"fullPrice":9.95,"finalPrice":9.95,"productName":"Blue Clarity Shield - Case UPGRADE!","discountAmount":0,"discountPercentage":0},{"name":"Blue Clarity Shield - Expedited Shipping","id":1893,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Blue Clarity Shield - Expedited Shipping","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Blue Clarity Shield","id":1892,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Blue Clarity Shield","discountAmount":0,"discountPercentage":0},{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0}];
    ...
    const response = await fetch(
      `http://localhost:5020/vrio/order_offers`,
      {
        ...
        body: JSON.stringify({
          ...
          order_id: lastOrderId,
          pageId: "vUf2we4WptzJIfXThHW8rEQ5rrzUpYdSTtxVU5Qb5VH52a1Zb2xixJiEWXdkslSH"
        })
      }
    );
...
const processUpsell = async () => {
  ...
  try {
    const orderData = JSON.parse(sessionStorage.getItem("orderData"));
    orderData.pageId = "vUf2we4WptzJIfXThHW8rEQ5rrzUpYdSTtxVU5Qb5VH52a1Zb2xixJiEWXdkslSH";
    const lastOrderId = sessionStorage.getItem("cms_oid");
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      runId: "initial",
      hypothesisId: "KlaviyoLifecycle",
      data: { pageName: "BCS-Upsell2", pageType: "Upsell" },
    };
